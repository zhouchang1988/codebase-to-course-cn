...
| | 普通版（默认） | 专业版 |
|---|---|---|
| **面向谁** | 非技术人员、「氛围程序员」 | 专业程序员 |
| **怎么教** | 通俗翻译、生活隐喻 | 架构图、数据流动画、技术方案 |
| **代码展示** | 完整代码 + 逐行翻译 | 精选 10-15 行核心代码 |
| **测验** | 每个模块默认包含 | 默认不含，按需添加 |
| **视觉风格** | 温暖亲切，像翻阅教材 | 简洁专业，信息密度高 |

## 交互元素

- **代码↔中文翻译块** — 左侧代码，右侧通俗解释
- **群聊动画** — 组件之间的对话模拟
- **数据流/消息流动画** — 请求从 A 到 B 的可视化
- **架构图** — 点击组件查看描述（专业版）
- **时序图/状态图** — 生命周期与状态流转（专业版）
- **嵌入式测验** — 多选、场景、拖放、找 bug
- **词汇表提示** — 技术术语首次出现时自动标注
